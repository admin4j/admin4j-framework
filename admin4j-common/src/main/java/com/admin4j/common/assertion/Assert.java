...
import com.admin4j.common.exception.WrapMessageException;
...
public interface Assert {
     ...
     * @return
     */
    Admin4jException newException(Throwable t, String errMsg);

    Admin4jException newException(Throwable t);
     ...
     * @return
     */
    default Admin4jException newException(String errMsg, Object... args) {
     ...
     * 创建一个 {@link WrapMessageException} 异常, 再以入参的形式传给
     ...
     * @return
     */
    default Admin4jException newException(Throwable t, String errMsg, Object... args) {
        if (args != null && args.length > 0) {
            errMsg = MessageFormat.format(errMsg, args);
        }
